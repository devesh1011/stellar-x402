...
Enhance your development experience with AI-powered IDE integration for stellar-x402.

## Overview

Stellar x402 provides a comprehensive MDC (Model Development Context) file that enables seamless integration with AI-powered IDEs like Cursor. This integration provides intelligent code suggestions, automatic setup guidance, and best practices for implementing blockchain micropayments.
...
Download the stellar-x402 MDC context file directly from GitHub:
...
Once the MDC file is loaded, Cursor will automatically understand how to integrate stellar-x402 into your project. You can:

- Ask Cursor to "Add x402 payment protection to my API routes"
- Request "Set up stellar-x402 middleware for Next.js"
- Get help with "Configure environment variables for stellar-x402"
...
1. Ensure the file is in `.cursor/rules/stellar-x402.mdc`
2. Restart Cursor IDE
...
Make sure you have TypeScript configured in your project and the stellar-x402 types are properly imported.

## Contributing

If you find issues with the MDC file or want to add new patterns:

1. Update the `.cursor/rules/stellar-x402.mdc` file
...
- [GitHub Repository](https://github.com/adipundir/stellar-x402)
...
- Open an issue on [GitHub](https://github.com/adipundir/stellar-x402/issues)
