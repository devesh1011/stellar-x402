...
const res = await wrapFetchWithPayment.get(
...
- SDK builds/signs Stellar transfer, sets X-PAYMENT header, and retries
...
```
https://stellar-x402.vercel.app/api/facilitator
```
