...
```bash
npm install stellar-x402 @stellar/stellar-sdk next
```
...
Full source code: [examples/simple-seller](https://github.com/adipundir/stellar-x402/tree/main/examples/simple-seller)
