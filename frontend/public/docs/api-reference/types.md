...
Complete, accurate TypeScript types exported by stellar-x402.
...
const APTOS_TESTNET = "stellar-testnet";
...
```typescript
import type { RouteConfig, FacilitatorConfig } from "stellar-x402/types";
...
import type { X402PaymentResponse } from "stellar-x402";
