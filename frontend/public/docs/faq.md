...
<details>
<summary><strong>Why Stellar for x402?</strong></summary>

Stellar provides optimal characteristics for micropayments:
...
| **Settlement**   | 1-3s    | Stellar blockchain finality   |
...
- Generate: Use Petra/Martian wallet or `Keypair.random()`

**For API Consumers (Buyers):**

- Need funded wallet with private key
- Must have APT balance for payments + gas
- Get testnet XLM: [stellar.com/testnet-faucet](https://stellar.com/tools/testnet-reset)
...
1. **Public:** `https://stellar-x402.vercel.app/api/facilitator` (free)
...
3. Get free testnet XLM:
   [stellar.com/testnet-faucet](https://stellar.com/tools/testnet-reset)
...
const data = await wrapFetchWithPayment.get(apiUrl, {
  keypair: agent.privateKey,
});
...
- [Full Documentation](https://stellar-x402.vercel.app)
- [Report Issues](https://github.com/adipundir/stellar-x402/issues)
- [Discussions](https://github.com/adipundir/stellar-x402/discussions)
- [Twitter: @adipundir](https://x.com/adipundir)

**Additional:**

- [x402 Protocol Spec](https://github.com/coinbase/x402)
- [Stellar Developer Docs](https://aptos.dev)
